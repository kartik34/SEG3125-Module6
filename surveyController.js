...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var navigate = readData("navigate");
        var organization = readData("organization");
        res.render('showResults', {results: [organization, navigate, improved, likely, design, comments]});
        console.log([organization, navigate, improved, likely, design, comments]);
    });
